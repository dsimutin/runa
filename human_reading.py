...
HUMAN_READING_TEXT = (
    ...
    "получаешь короткую интерпретацию с практическим выводом. "
    ...
    "💡 <i>С премиумом — 3 таких расклада в месяц бесплатно, плюс расклад на год и расклад на взаимоотношения. "
...
HUMAN_READING_PAID_PROMPT = (
    ...
    "Постарайся сформулировать ситуацию коротко и по сути."
)
