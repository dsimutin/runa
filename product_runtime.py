...
HUMAN_QUESTION_OPENINGS = {
    "light": [
        "❓ <b>{name}, смотрю как вопрос «да/нет»</b>\nЗдесь ответ не резкий. Скорее карта показывает, где внутри уже есть тихое понимание.",
        ...
        "❓ <b>{name}, давай аккуратно</b>\nЗдесь лучше не давить на ответ. Он проявляется через ощущение, а не через спор с собой.",
    ],
    "dark": [
    ...
    "premium": [
        "❓ <b>{name}, смотрю как вопрос «да/нет»</b>\nЗдесь ответ прячется не в событии, а в мотиве, который за ним стоит.",
        ...
        "❓ <b>{name}, по подтексту</b>\nЗдесь важно не спешить с формальным да или нет. Есть слой, который меняет смысл.",
