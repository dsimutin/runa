...
PREMIUM_BENEFITS = (
    ...
    "✌️ <b>Расклад на пару</b> — три руны: ты, партнёр и что между вами. Для любых отношений.\n\n"
    "🕯 <b>3 личных расклада в месяц</b> — живой ответ человека на твой вопрос за 5–10 минут.\n\n"
